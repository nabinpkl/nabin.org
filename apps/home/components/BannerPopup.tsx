...
const bannerMessages = [
  {
    text: "I love building tools and solving user frictions.",
    icon: () => (
  ...
  {
    text: "I live and breathe in product design and development.",
    icon: () => (
  ...
  {
    text: "I love sharing that passion with others.",
    icon: () => (
